...
struct Card: Identifiable, Hashable {
    ...
    var isFirtsBlankCard : Bool = false
...
var sampleCards: [Card] = [
    ...
    .init(cardName: "", cardColor: .clear, cardBalance: "", isFirtsBlankCard: true),
    .init(cardName: "iJustine", cardColor: Color("Card 1"), cardBalance: "$1024.9", expenses:[
        ...
        .init(cardName: "iJustine", cardColor: Color("Card 3"), cardBalance: "$1024.9", expenses:[
